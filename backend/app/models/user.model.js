...
const createUser = (userDetails) => {
    ...
    const user = new User({firstName: userDetails.firstName, lastName: userDetails.lastName, password: encryptedPassword, email: userDetails.email,phoneNumber:userDetails.phoneNumber})
    return user.save()
}
/**
